    ...
    <div className="fixed-plugin">
      <div className={classes}>
        ...
        <ul className="dropdown-menu show">
          <li className="header-title">FONDO PANEL NAVEGACIÓN</li>
          ...
          <li className="header-title">COLOR DE INDICADOR ACTIVO</li>
          <li className="adjustments-line">
            <div className="badge-colors text-center">
              <span
                className={
          ...
          <li className="header-title">PANEL NAVEGACIÓN</li>
          <li className="adjustments-line">

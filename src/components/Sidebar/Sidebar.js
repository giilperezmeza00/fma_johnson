...
import avatar from "assets/img/faces/olvera.jpg";
import logo from "assets/img/fma.jpg";
              ...
              <ul className="nav">
                <li>
                  <NavLink to="/admin/user-profile" activeClassName="">
                    ...
                    <span className="sidebar-normal">Mi Usuario</span>
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/admin/user-profile" activeClassName="">
                    <span className="sidebar-mini-icon">A</span>
                    <span className="sidebar-normal">Ajustes</span>
                  </NavLink>
                </li>
              </ul>
            </Collapse>
